...
class doctorController{
	...
	public function index()
    {
        ...
        $breadcrumbs = array(
            array("icon" => "clip-home", "msg" => "MENU_HOME_DOCTOR")
        );



        $view = 'views/doctor/index.php';
	...
	public function getall()
	{
		...
		$arr = Doctor::findAlltable($limitstart, $perpage, $order, $keyorder, $search, $idcompany);
		$total = Doctor::countalltable($search, $idcompany);
		...
		require_once('views/doctor/table.php');
	}
