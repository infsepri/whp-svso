...
class nurseController{
	...
	public function index()
    {
        ...
        $breadcrumbs = array(
            array("icon" => "clip-home", "msg" => "MENU_HOME_NURSE")
        );



        $view = 'views/nurse/index.php';
	...
	public function getall()
	{
		...
		$arr = Nurse::findAlltable($limitstart, $perpage, $order, $keyorder, $search, $idcompany);
		$total = Nurse::countalltable($search, $idcompany);
		...
		require_once('views/nurse/table.php');
	}
