...
class physiotherapistController{
	...
	public function index()
    {
        ...
        $breadcrumbs = array(
            array("icon" => "clip-home", "msg" => "MENU_HOME_PHYSIOTHERAPIST")
        );



        $view = 'views/physiotherapist/index.php';
	...
	public function getall()
	{
		...
		$arr = Physiotherapist::findAlltable($limitstart, $perpage, $order, $keyorder, $search, $idcompany);
		$total = Physiotherapist::countalltable($search, $idcompany);
		...
		require_once('views/physiotherapist/table.php');
	}
